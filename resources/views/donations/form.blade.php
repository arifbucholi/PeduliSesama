                ...
                <div class="col-6 mx-auto">
                  <div class="card" style="border-radius: 10px">
                    <div class="card-body" style=" background:#252525;border-radius:7px; padding-top:10px">
                      <div>
                          <form action="/donations/confirm" method="POST" >
                              @csrf
                              <label for="title">Judul program</label>
                              <div class="input-group">
                                <h1 style="color: #FFFFFD">{{ $c->title }}</h1>
                                <input hidden type="text" class="form-control" name="category" value="{{ $c->category }}">
                                <input hidden type="text" class="form-control" name="campaign_id" value="{{ $c->id }}">
                              </div>
                              ...
                              <div class="input-group">
                                  ...
                                  <input class="form-control" type="number" id="angkaInput" name="amount" placeholder="Masukkan nominal. Contoh : 10.000" style="color:#FFFFFD" required>
                              ...
                              <div class="row justify content-center col-8">
                                <div class="form-check col-6">
                                    <input class="form-check-input" type="radio" name="is_donor_hidden" id="flexRadioDefault1" value="0">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Asli
                                    </label>
                                </div>
                                <div class="form-check col-6">
                                    <input class="form-check-input" type="radio" name="is_donor_hidden" id="flexRadioDefault2" value="1">
